  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Container(
        child: Column(
          children: [
            Image.asset("assets/confirmed.png").paddingOnly(top:80,bottom: 50,left: 50,right: 50),
            RichText(
              textAlign: TextAlign.center,
              text: TextSpan(text: "Your Order is on the way\n\n",
              style:GoogleFonts.ubuntu(fontSize:22,fontWeight: FontWeight.w400,color: Colors.black),
              children: [
                TextSpan(
                  text:"Thank you for yor order you can track the delivery in order section",
                  style:GoogleFonts.ubuntu(fontSize:16,fontWeight: FontWeight.w300,color: Colors.black54)
                )
              ]
              ),),
            Spacer(),

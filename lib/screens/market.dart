    ...
    return Scaffold(
      ...
      body: CustomScrollView(
        ...
        if(!market.status!)
          ...
          ///SearchField
          SliverToBoxAdapter(
              child: SearchInput(_searchController, "Search for category",
          ...
          builder: (context, snapshot) {
            ...
            return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return CategoryWidget(snapshot.data![index].name!,snapshot.data![index].image!)
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                return GestureDetector(
                  onTap: ()=> Navigator.pushNamed(context, Category.id,arguments: [market,_categoryProvider.categories[index].id]),
                  child: CategoryWidget(_categoryProvider.categories[index].name!,_categoryProvider.categories[index].image!)

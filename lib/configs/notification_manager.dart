...
class LocalNotifyManager {
  ...
  BehaviorSubject<RecieveNotification> get didReceiveLocalNotificationSubject => BehaviorSubject<RecieveNotification>();
  var initSetting;
  ...
  initializePlatform(){
    ...
    var initSettingIOS = IOSInitializationSettings(
      ...
      onDidReceiveLocalNotification: (id,title,body,payload)async{
        RecieveNotification notification = RecieveNotification(id: id, title: title, body: body, payload: payload);
    ...
    Future<void> showNotification(int id,String title,String body) async {
        var androidChannel = AndroidNotificationDetails('channelId', 'channelName', 'channelDescription',importance: Importance.max,priority: Priority.high,playSound: true);
...
class RecieveNotification {
  ...
  String? body;
  String? payload;
  RecieveNotification({@required this.id,@required this.title,@required this.body,@required this.payload});
}